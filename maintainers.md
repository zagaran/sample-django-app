...
3. Ensure that the code runs properly on `sample-django-app` and is styled properly.  In particular, check the following URLS:
    1. http://localhost:8000/
    2. http://localhost:8000/django-react/
    3. http://localhost:8000/report-demo/
